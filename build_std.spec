...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'services.media_operation_guard',
        ...
        'services.project_materials',
        'services.thumbnail_coordinator',
        ...
        'exporting.filter_graph',
        'exporting.executor',
        'exporting.verifier',
        'exporting.committer',
        'exporting.queue_store',
        'exporting.queue_service',
        'exporting.ingestion',
        'exporting.diagnostics',
        'exporting.exit_coordinator',
        'hotkey',
...
cli_analysis = Analysis(
    ...
    hiddenimports=[
        ...
        'exporting.diagnostics',
        'services',
        'services.capture_capability',
        'services.capture_capability_runtime',
        'services.capture_self_test',
        'services.project_library',
        'services.project_save_coordinator',
        'services.timeline_edit_service',
        'services.timeline_history',
...
cli_analysis.binaries = [
    b for b in cli_analysis.binaries if not _should_exclude(b[0])
]
cli_analysis.datas = [
    d for d in cli_analysis.datas if not _should_exclude(d[0])
]
