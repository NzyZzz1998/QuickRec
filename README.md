...
QuickRec Full 是 QuickRec 的完整功能产品线工作区，当前正式版本为 **v1.5**；**v1.6 轻量素材库基础版已完成开发与发布前验收，正在发布收口**。v1.5 作为本次发布回滚点，本目录不承接 QuickRec Lite 的轻量化裁剪路线。
...
> 当前开发目录：`doc/releases/v1.6/`
> 当前开发分支：`feature/v1.6-material-library`
> v1.5 发布包：`QuickRec-v1.5-win-x64.zip`
> v1.5 Release：[GitHub Releases](https://github.com/NzyZzz1998/QuickRec/releases/tag/v1.5)
...
v1.6 发布与验收文档位于 `doc/releases/v1.6/`，以 `progress.md` 和 `verification.md` 为实时状态入口。
